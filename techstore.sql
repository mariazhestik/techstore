...
--
-- Хост: 127.0.0.1
-- Час створення: Трв 14 2024 р., 18:03
...
(1, 1, 'Samsung Galaxy S20', 799.99, 'Snapdragon 865', '128GB', '8GB', 'AMOLED', 'Glass', 'Black', '6.2\"', '4000mAh', 'Available'),
...
--
-- Дамп даних таблиці `store_inventory`
--
...
--
-- Індекси таблиці `store_inventory`
--
...
--
-- Обмеження зовнішнього ключа таблиці `store_inventory`
--
ALTER TABLE `store_inventory`
